...
String apiKey = "CIP6F2INXWORLLDD";     //  Tulis API key kamu dari ThingSpeak
 
const char *ssid =  "NANDA POIN";     // Ganti dengan wifi dan password kamu
const char *pass =  "BOGEL123";
